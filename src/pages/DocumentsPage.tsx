        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
          <div className="p-5">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-4">
              <div>
                <label htmlFor="doc-filter-patient-id" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Patient ID</label>
              ...
              <div>
                <label htmlFor="doc-filter-patient-name" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Patient Name</label>
                <div className="relative mt-1">
                  <SearchIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300 dark:text-gray-600 pointer-events-none" />
                  <input
              ...
              <div>
                <label htmlFor="doc-filter-status" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Status</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="doc-filter-document-type" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Document Type</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="doc-filter-assignee" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Assignee</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="doc-filter-created-date" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Created Date</label>
                <DateFilterInput id="doc-filter-created-date" value={createdDateFilter} onChange={setCreatedDateFilter} />
              </div>

              <div>
                <label htmlFor="doc-filter-receive-method" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Receive Method</label>
                <div className="relative mt-1">
                  <select
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
                  ...
                  <th className="text-left text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide px-4 py-3.5">Document</th>
                  <th className="text-left text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide px-4 py-3.5 whitespace-nowrap">Patient Name/ID</th>
                  <th className="text-left text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide px-4 py-3.5">Receive</th>
                </tr>
              </thead>
              <tbody>
                {visible.map(d => (
                  <tr key={d.id} className="border-b border-gray-50 dark:border-gray-800/60 hover:bg-gray-50/70 dark:hover:bg-gray-800/40 transition-colors">
                    ...
                    <td className="px-4 py-3.5">
                      <span className="inline-flex items-center px-2.5 py-1 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-[12px] font-medium">
                        {d.documentType}
                      </span>
                    </td>

                    <td className="px-4 py-3.5">
                      <p className="text-[13px] text-gray-700 dark:text-gray-300">{d.patientName}</p>
                      <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5">{d.patientId}</p>
                    </td>

                    <td className="px-4 py-3.5">
                      <p className="text-[13px] text-gray-700 dark:text-gray-300">{d.receiveMethod}</p>
                      <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5">{d.receiveDate}</p>
                    </td>
                  </tr>
                ))}
                {visible.length === 0 && (
                  <tr>
                    <td colSpan={6} className="px-4 py-10 text-center text-[13px] text-gray-400 dark:text-gray-500">No document requests match these filters.</td>
                  </tr>
                )}
              </tbody>
            </table>
