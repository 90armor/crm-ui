...
import { MEDICINE_PURPOSES, MEDICINE_REQUESTS } from '@/data/medicines'
...
import type { Contact, MedicineRequest, RequestStatus, MedicinePurpose } from '@/types/domain'
...
export function MedicinesPage() {
  ...
  const visible = useFilteredList(requests, r => {
    ...
    return true
  }, [statusFilter, purposeFilter, assigneeFilter, createdDateFilter, search])
  ...
  return (
    <>
      <header className="flex items-center justify-between px-6 py-3.5 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shrink-0">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Medicine</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <RequestStatusOverview title="Medicine Request Status Overview" counts={counts} />
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
          <div className="p-5">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-4">
              <div>
                <label htmlFor="med-filter-search" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Patient ID / Phone</label>
              ...
              <div>
                <label htmlFor="med-filter-status" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Status</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="med-filter-purpose" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Purpose</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="med-filter-assignee" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Assignee</label>
                <div className="relative mt-1">
                  <select
              ...
              <div>
                <label htmlFor="med-filter-created-date" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400">Created Date</label>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
                  ...
                  <th className="text-left text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide px-4 py-3.5">Items</th>
                </tr>
              </thead>
              <tbody>
                {visible.map(r => (
                  <tr key={r.id} className="border-b border-gray-50 dark:border-gray-800/60 hover:bg-gray-50/70 dark:hover:bg-gray-800/40 transition-colors">
                    ...
                    <td className="px-4 py-3.5 text-[13px] text-gray-700 dark:text-gray-300">{r.items}</td>
                  </tr>
                ))}
                {visible.length === 0 && (
                  <tr>
                    <td colSpan={5} className="px-4 py-10 text-center text-[13px] text-gray-400 dark:text-gray-500">No medicine requests match these filters.</td>
                  </tr>
                )}
              </tbody>
            </table>
