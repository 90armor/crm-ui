...
export const HUE: Record<Hue, HueTokens> = {
  gray:    { pill: 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400',       border: 'border-gray-200 dark:border-gray-700',    dot: 'bg-gray-300',   text: 'text-gray-400 dark:text-gray-500',   cardBorder: 'border-l-gray-400',    iconBg: 'bg-gray-50 dark:bg-gray-800',    iconText: 'text-gray-500 dark:text-gray-400' },
  amber:   { pill: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300',     border: 'border-amber-200 dark:border-amber-800',   dot: 'bg-amber-500',  text: 'text-amber-700 dark:text-amber-400',  cardBorder: 'border-l-amber-500',   iconBg: 'bg-amber-50 dark:bg-amber-900/20',   iconText: 'text-amber-500 dark:text-amber-400' },
  blue:    { pill: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300',       border: 'border-blue-200 dark:border-blue-800',    dot: 'bg-blue-500',   text: 'text-blue-700 dark:text-blue-400',   cardBorder: 'border-l-blue-500',    iconBg: 'bg-blue-50 dark:bg-blue-900/20',    iconText: 'text-blue-500 dark:text-blue-400' },
  purple:  { pill: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300',   border: 'border-purple-200 dark:border-purple-800',  dot: 'bg-purple-500', text: 'text-purple-700 dark:text-purple-400', cardBorder: 'border-l-purple-500',  iconBg: 'bg-purple-50 dark:bg-purple-900/20',  iconText: 'text-purple-500 dark:text-purple-400' },
  red:     { pill: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300',         border: 'border-red-200 dark:border-red-800',     dot: 'bg-red-500',    text: 'text-red-700 dark:text-red-400',    cardBorder: 'border-l-red-500',     iconBg: 'bg-red-50 dark:bg-red-900/20',     iconText: 'text-red-500 dark:text-red-400' },
  emerald: { pill: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300', border: 'border-emerald-200 dark:border-emerald-800', dot: 'bg-emerald-500', text: 'text-emerald-700 dark:text-emerald-400', cardBorder: 'border-l-emerald-500', iconBg: 'bg-emerald-50 dark:bg-emerald-900/20', iconText: 'text-emerald-500 dark:text-emerald-400' },
  violet:  { pill: 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300',   border: 'border-violet-200 dark:border-violet-800',  dot: 'bg-violet-500', text: 'text-violet-700 dark:text-violet-400', cardBorder: 'border-l-violet-500',  iconBg: 'bg-violet-50 dark:bg-violet-900/20',  iconText: 'text-violet-500 dark:text-violet-400' },
  indigo:  { pill: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300',   border: 'border-indigo-200 dark:border-indigo-800',  dot: 'bg-indigo-500', text: 'text-indigo-700 dark:text-indigo-400', cardBorder: 'border-l-indigo-500',  iconBg: 'bg-indigo-50 dark:bg-indigo-900/20',  iconText: 'text-indigo-500 dark:text-indigo-400' },
}
